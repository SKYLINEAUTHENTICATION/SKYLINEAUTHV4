...
export default function FilesPage() {
  ...
  const field = (key: string, label: string, opts?: any) => (
    <div style={{ marginBottom: 14 }}>
      <label style={{ fontSize: 12, color: "#aa44ff", fontWeight: 600, display: "block", marginBottom: 6 }}>{label}</label>
      {opts?.textarea ? (
        <textarea
          rows={3}
  ...
  return (
    <div style={{ padding: "28px 32px", background: "#000", minHeight: "100%" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32 }}>
        <div>
          <h1 style={{ margin: 0, fontSize: 26, fontWeight: 800, color: "#fff", fontFamily: "Inter, sans-serif" }}>Files</h1>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <a href="/portal" target="_blank" rel="noopener noreferrer" style={{
            ...
            borderRadius: 9, color: "#aa44ff", fontSize: 12, fontWeight: 600, cursor: "pointer",
            textDecoration: "none",
          }}>
          ...
          {canCreate && (
            <button onClick={() => setShowCreate(true)} data-testid="button-new-file" style={{
              ...
              cursor: "pointer", boxShadow: "0 4px 20px rgba(102,0,255,0.4)", transition: "transform 0.15s",
            }}
      ...
      {showCreate && (
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: "0 24px 80px rgba(102,0,255,0.3)", maxHeight: "90vh", overflowY: "auto",
          }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 20 }}>
          {files.map((file: any) => (
            <div
              ...
              style={{
                background: "linear-gradient(145deg, rgba(255,255,255,0.03), rgba(102,0,255,0.04))",
              ...
              onMouseEnter={(e) => {
                ...
                el.style.boxShadow = "0 16px 48px rgba(102,0,255,0.2)";
                el.style.borderColor = "rgba(102,0,255,0.45)";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget;
                el.style.transform = "";
                el.style.boxShadow = "none";
                el.style.borderColor = "rgba(102,0,255,0.2)";
              }}
            >
              ...
              {file.changelog && (
                <div style={{
                  ...
                  <p style={{ margin: "0 0 3px", fontSize: 10, color: "#7722ff", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.5px" }}>Changelog</p>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", justifyContent: "space-between" }}>
                ...
                <a
                  ...
                  style={{
                    ...
                    background: "linear-gradient(135deg, rgba(102,0,255,0.4), rgba(99,102,241,0.3))",
                    border: "1px solid rgba(102,0,255,0.35)",
                    color: "#aa44ff", fontSize: 12, fontWeight: 600,
                    textDecoration: "none", transition: "all 0.2s",
                    boxShadow: "0 2px 8px rgba(102,0,255,0.2)",
                  }}
                  onMouseEnter={(e) => e.currentTarget.style.background = "linear-gradient(135deg, rgba(102,0,255,0.6), rgba(99,102,241,0.5))"}
                  onMouseLeave={(e) => e.currentTarget.style.background = "linear-gradient(135deg, rgba(102,0,255,0.4), rgba(99,102,241,0.3))"}
                >
